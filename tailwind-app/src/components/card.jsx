...
function Card( {username, btnText = "Visit me"} ){ // destructuring props in card
  return ( // also btnText = "visit me" is the default value that we pass if btn text property is not passed 
    <div>
